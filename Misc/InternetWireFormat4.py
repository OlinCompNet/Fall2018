...
class Internet_Wire_Format:
    ...
    def __init__(self):
        ...
        print("Internet Wire Format Init")
        
    
               
    def __enter__(self):
        print("Internet Wire Format Enter")
        return self

    def __exit__(self,a,b,c):
        print("Internet Wire Format Exit")
        return a==b==c
    ...
    def boundary(self,bit_boundary:Nat)->Nat:
        ...
        current_bit_offset = self.bit_offset%bit_boundary #determine if already on display_width
